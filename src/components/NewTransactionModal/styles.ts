...
export const Content = styled(Dialog.Content)`
  ...
  position: fixed; //hack para centralizar coisas na tela
  top: 50%; //hack para centralizar coisas na tela
  left: 50%; //hack para centralizar coisas na tela
  transform: translate(-50%, -50%); //hack para centralizar coisas na tela
  //basta fazer do position ao transform
